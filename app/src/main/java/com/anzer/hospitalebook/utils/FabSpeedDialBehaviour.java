...
public class FabSpeedDialBehaviour extends CoordinatorLayout.Behavior<io.github.yavski.fabspeeddial.FabSpeedDial> {
    ...
    @Override
    public boolean layoutDependsOn(CoordinatorLayout parent, io.github.yavski.fabspeeddial.FabSpeedDial child, View dependency) {
        // We're dependent on all SnackbarLayouts (if enabled)
        return SNACKBAR_BEHAVIOR_ENABLED && dependency instanceof Snackbar.SnackbarLayout;
    }

    @Override
    public boolean onDependentViewChanged(CoordinatorLayout parent, io.github.yavski.fabspeeddial.FabSpeedDial child,
                                          View dependency) {
    ...
    private void updateFabTranslationForSnackbar(CoordinatorLayout parent,
                                                 final io.github.yavski.fabspeeddial.FabSpeedDial fab, View snackbar) {
        ...
        if (Math.abs(currentTransY - targetTransY) > (fab.getHeight() * 0.667f)) {
            mFabTranslationYAnimator = ViewCompat.animate(fab)
                    .setInterpolator(io.github.yavski.fabspeeddial.FabSpeedDial.FAST_OUT_SLOW_IN_INTERPOLATOR)
    ...
    private float getFabTranslationYForSnackbar(CoordinatorLayout parent,
                                                io.github.yavski.fabspeeddial.FabSpeedDial fab) {
        float minOffset = 0;
    ...
    @Override
    public boolean onLayoutChild(CoordinatorLayout parent, io.github.yavski.fabspeeddial.FabSpeedDial child, int layoutDirection) {
    ...
    private boolean updateFabVisibility(CoordinatorLayout parent, AppBarLayout appBarLayout,
                                        io.github.yavski.fabspeeddial.FabSpeedDial child) {
